...
bool can_publish;  // if can publish

int samples_to_use_for_bias;

geometry_msgs::WrenchStamped::ConstPtr wrench_in;
...
bool compute_bias_service_cb(std_srvs::Trigger::Request &request, std_srvs::Trigger::Response &response)
{
  can_publish = false;
  compute_bias();
  can_publish = true;
...
int main(int argc, char *argv[])
{
  ...
  /*******INIT ROS SUB**********/
  sub_wrench = nh_public.subscribe(str_in_topic, 1, read_wrench_cb);
  /***************************/
...
void compute_bias()
{
  ...
  // set bias to zero
  geometry_msgs::WrenchStamped wrench_bias_local;
  wrench_bias_local.wrench.force.x = 0.0;
  wrench_bias_local.wrench.force.y = 0.0;
  wrench_bias_local.wrench.force.z = 0.0;
  wrench_bias_local.wrench.torque.x = 0.0;
  wrench_bias_local.wrench.torque.y = 0.0;
  wrench_bias_local.wrench.torque.z = 0.0;

  // Compute bias
  for (int i = 0; i < samples_to_use_for_bias; i++)
  {
    wait_wrench_measure();
    wrench_bias_local.wrench.force.x += wrench_in->wrench.force.x;
    wrench_bias_local.wrench.force.y += wrench_in->wrench.force.y;
    wrench_bias_local.wrench.force.z += wrench_in->wrench.force.z;
    wrench_bias_local.wrench.torque.x += wrench_in->wrench.torque.x;
    wrench_bias_local.wrench.torque.y += wrench_in->wrench.torque.y;
    wrench_bias_local.wrench.torque.z += wrench_in->wrench.torque.z;
  }
  wrench_bias_local.wrench.force.x /= samples_to_use_for_bias;
  wrench_bias_local.wrench.force.y /= samples_to_use_for_bias;
  wrench_bias_local.wrench.force.z /= samples_to_use_for_bias;
  wrench_bias_local.wrench.torque.x /= samples_to_use_for_bias;
  wrench_bias_local.wrench.torque.y /= samples_to_use_for_bias;
  wrench_bias_local.wrench.torque.z /= samples_to_use_for_bias;
  wrench_bias_local.header.stamp = ros::Time::now();

  wrench_bias = wrench_bias_local;
  ROS_INFO("wrench_bias: Compute Bias DONE");
}

void wait_wrench_measure()
{
  wrench_in = ros::topic::waitForMessage<geometry_msgs::WrenchStamped>(sub_wrench.getTopic());
}